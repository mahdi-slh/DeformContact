...
from tensorboardX import SummaryWriter  # Import the TensorboardX module
...
if __name__ == "__main__":
    config = Config()
    writer = SummaryWriter('logs/')  # Create a SummaryWriter object. 'logs/' is the directory where log files will be saved.
